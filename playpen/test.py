...
if __name__ == "__main__":
    ...
    print('#' * 100)
    test(host="ec2-184-72-159-16.compute-1.amazonaws.com", port=443, url="/api/account/503b7875d9c141421c55bd92/contracts/0/",
        username="shadowman@redhat.com", password="shadowman@redhat.com", debug=True) 
    print('#' * 100)
    test(host="ec2-184-72-159-16.compute-1.amazonaws.com", port=443, url="/api/account/503b7875d9c141421c55bd92/contracts/1/",
        username="shadowman@redhat.com", password="shadowman@redhat.com", debug=True) 
