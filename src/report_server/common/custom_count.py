...
class Rules:
    def init(self): 
        ...
        report_biz_rules[RHEL]['memtotal']={'low_gt': 0, 'low_lt': 8388608, 'low_desc': '< 8GB', 'high_gt': 8388608, 'high_lt': 83886080, 'high_desc': '> 8GB', 'rule': '0 > 8388608; 8388608 > 83886080'}
        ...
        report_biz_rules[JBoss]['cpu_sockets']={'low_gt': 0, 'low_lt': 5, 'low_desc': '<= 4 Sockets', 'high_gt': 4, 'high_lt': 6, 'high_desc': '> 4 Sockets', 'rule': '<= 4 ; 4 > 6' }
        ...
        report_biz_rules[UNLIMITED]['cpu_sockets']={'low_gt': 0, 'low_lt': 3, 'low_desc': ' <= 2 CPU Sockets', 'high_gt': 2, 'high_lt': 5, 'high_desc': '2 > socket <= 4 ', 'rule': '0 > 3; 2 > 5'}
        report_biz_rules[UNLIMITED]['calculation']=interval
        
        report_biz_rules[HA]['cpu']=[]
        report_biz_rules[HA]['memtotal']={'low_gt': 0, 'low_lt': 8388608, 'low_desc': '< 8GB', 'high_gt': 8388608, 'high_lt': 83886080, 'high_desc': '> 8GB', 'rule': '0 > 8388608; 8388608 > 83886080'}
        ...
        report_biz_rules[EUS]['memtotal']={'low_gt': 0, 'low_lt': 8388608, 'low_desc': '< 8GB', 'high_gt': 8388608, 'high_lt': 83886080, 'high_desc': '> 8GB', 'rule': '0 > 8388608; 8388608 > 83886080'}
        ...
        report_biz_rules[LB]['memtotal']={'low_gt': 0, 'low_lt': 8388608, 'low_desc': '< 8GB', 'high_gt': 8388608, 'high_lt': 83886080, 'high_desc': '> 8GB', 'rule': '0 > 8388608; 8388608 > 83886080'}
