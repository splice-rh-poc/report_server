...
'''
The dictionaries in this module should be replaced by an api call to the mothership
...
class Rules:
    def init(self): 
        ...
        report_biz_rules[RHEL]['memtotal']={'low_gt': 0, 'low_lt': 8388608, 'low_desc': '< 8GB', 'high_gt': 8388608, 'high_lt': -1, 'high_desc': '> 8GB', 'rule': '0 > 8388608; > 8388608'}
        ...
        report_biz_rules[JBoss]['cpu_sockets']={'low_gt': 0, 'low_lt': 5, 'low_desc': '<= 4 Sockets', 'high_gt': 4, 'high_lt': 6, 'high_desc': '> 4 Sockets', 'rule': '<= 4 Sockets; > 4 Sockets' }
        report_biz_rules[JBoss]['calculation']=interval
        
        
        report_biz_rules[GEAR]['cpu']={'low_gt': 0, 'low_lt': 2, 'low_desc': ' 1 cpu', 'high_gt': 1, 'high_lt': -1, 'high_desc': '> 1 cpu', 'rule': '0 > 2; > 1'}
        report_biz_rules[GEAR]['memtotal']= {'low_gt': 0, 'low_lt': 2097153, 'low_desc': ' <= 2GB', 'high_gt': 2097152, 'high_lt': -1, 'high_desc': '> 2GB', 'rule': '0 > 2097153; > 2097152'}
        ...
        report_biz_rules[UNLIMITED]['cpu_sockets']={'low_gt': 0, 'low_lt': 3, 'low_desc': ' <= 2 CPU Sockets', 'high_gt': 2, 'high_lt': 5, 'high_desc': '2 > socket <= 4 ', 'rule': '0 > 3; > 2'}
        report_biz_rules[UNLIMITED]['calculation']=interval
        
        report_biz_rules[HA]['cpu']=[]
        report_biz_rules[HA]['memtotal']={'low_gt': 0, 'low_lt': 8388608, 'low_desc': '< 8GB', 'high_gt': 8388608, 'high_lt': -1, 'high_desc': '> 8GB', 'rule': '0 > 8388608; > 8388608'}
        ...
        report_biz_rules[EUS]['memtotal']={'low_gt': 0, 'low_lt': 8388608, 'low_desc': '< 8GB', 'high_gt': 8388608, 'high_lt': -1, 'high_desc': '> 8GB', 'rule': '0 > 8388608; > 8388608'}
        ...
        report_biz_rules[EDU]['memtotal']={'low_gt': 0, 'low_lt': 8388608, 'low_desc': '< 8GB', 'high_gt': 8388608, 'high_lt': -1, 'high_desc': '> 8GB', 'rule': '0 > 8388608; > 8388608'}
        report_biz_rules[EDU]['cpu_sockets']=[]
        report_biz_rules[EDU]['calculation']=interval
        
        report_biz_rules[LB]['cpu']=[]
        report_biz_rules[LB]['memtotal']={'low_gt': 0, 'low_lt': 8388608, 'low_desc': '< 8GB', 'high_gt': 8388608, 'high_lt': -1, 'high_desc': '> 8GB', 'rule': '0 > 8388608; > 8388608'}
