...
urlpatterns = patterns('',
    ...
    (r'^ui/ui20/$', 'report_server.sreport.views.ui20'),
    (r'^ui/ui20/index/$', 'report_server.sreport.views.index_ui20'),
    (r'^ui/ui20/import/$', 'report_server.sreport.views.import_ui20'),
    (r'^ui/ui20/login/$', 'report_server.sreport.views.login_ui20'),
    (r'^ui/ui20/logout/$', 'report_server.sreport.views.logout_ui20'),
    (r'^ui/ui20/report_form/$', 'report_server.sreport.views.report_form_ui20'),
    (r'^ui/ui20/report/$', 'report_server.sreport.views.report_ui20'),
    (r'^ui/ui20/details/$', 'report_server.sreport.views.detailed_report_ui20'),
    (r'^ui/ui20/max_report/$', 'report_server.sreport.views.max_report'),
    (r'^ui/ui20/instance_details/$', 'report_server.sreport.views.instance_detail_ui20'),
)
