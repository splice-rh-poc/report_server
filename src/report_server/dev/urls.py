...
urlpatterns = patterns('',
    ...
    (r'^report-server/ui20/$', 'report_server.sreport.views.ui20'),
    (r'^report-server/ui20/index/$', 'report_server.sreport.views.index_ui20'),
    (r'^report-server/ui20/import/$', 'report_server.sreport.views.import_ui20'),
    (r'^report-server/ui20/login/$', 'report_server.sreport.views.login_ui20'),
    (r'^report-server/ui20/logout/$', 'report_server.sreport.views.logout_ui20'),
    (r'^report-server/ui20/report_form/$', 'report_server.sreport.meter.views.report_form'),
    (r'^report-server/ui20/report_form_rhics/$', 'report_server.sreport.views.report_form_rhics'),
    (r'^report-server/ui20/report/$', 'report_server.sreport.views.report_ui20'),
    (r'^report-server/ui20/default_report/$', 'report_server.sreport.views.default_report'),
    ...
    (r'^report-server/ui20/fact_compliance/$', 'report_server.sreport.views.system_fact_compliance'),
    (r'^report-server/ui20/instance_details/$', 'report_server.sreport.views.instance_detail_ui20'),
    
    (r'^report-server/space/$', 'report_server.sreport.views.ui20'),
